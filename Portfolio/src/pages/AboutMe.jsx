...
const AboutMe = () => {
    const times = [
        {
            imgUrl: "AboutMeImages/cs50port.png", date: "August 2022", desc: `I wanted to start learning how to code, 
        ...
        { imgUrl: "AboutMeImages/a.png", date: "", desc: "" },
        { imgUrl: "AboutMeImages/b.png", date: "", desc: "" },
        { imgUrl: "AboutMeImages/c.png", date: "", desc: "" },
        { imgUrl: "AboutMeImages/d.png", date: "", desc: "" }
    ]
